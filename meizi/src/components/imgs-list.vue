<template>
<div class="container" v-infinite-scroll="loadMore" infinite-scroll-distance="720" infinite-scroll-throttle-delay="100" infinite-scroll-disabled="busy" :item="items">
<div class="waterfall">
...
<script>
	...
	export default {
		...
		methods: {
			...
			fetchJson() {
				axios.get("https://raw.githubusercontent.com/chenjiandongx/mmjpg/master/yummy.json").then(response => {
